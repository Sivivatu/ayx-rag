...
class TestProductExtraction:
    ...
    def test_extract_products_designer_base_url(self):
        ...
        from sitemap_filter.filters.product import extract_products
...
class TestProductFiltering:
    ...
    def sample_entries(self):
        ...
        return [
            ...
            URLEntry(
                "https://help.alteryx.com/current/en/server.html", "2025-10-24", "en", ["server"]
            ),
            URLEntry(
                "https://help.alteryx.com/current/en/connect.html", "2025-10-25", "en", ["connect"]
            ),
            URLEntry(
            ...
            URLEntry(
                "https://help.alteryx.com/current/en/release-notes.html", "2025-10-27", "en", []
            ),
        ]
