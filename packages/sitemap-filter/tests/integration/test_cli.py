...
class TestCLIProductFilter:
    ...
    def test_cli_with_product_designer_flag(self, sample_sitemap_path):
        ...
        result = runner.invoke(app, [str(sample_sitemap_path), "--product", "designer", "--dry-run"])
        assert result.exit_code == 0
...
class TestCLIErrorHandling:
    ...
    def test_cli_with_invalid_format(self, tmp_path):
        ...
        sitemap.write_text('<?xml version="1.0"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"></urlset>')
