...
class TestPerformance:
    ...
    def test_large_sitemap_processing_speed(self, large_sitemap_path):
        ...
        assert elapsed_time < 3.0, f"Processing took {elapsed_time:.3f} seconds, expected < 3.0 seconds"
    ...
    def test_json_output_performance(self, large_sitemap_path):
        ...
        assert result.exit_code == 0
        assert elapsed_time < 5.0, f"JSON output took {elapsed_time:.3f} seconds, expected < 5.0 seconds"
    ...
    def test_text_output_performance(self, large_sitemap_path):
        ...
        assert result.exit_code == 0
        assert elapsed_time < 5.0, f"Text output took {elapsed_time:.3f} seconds, expected < 5.0 seconds"
    ...
    def test_xml_output_performance(self, large_sitemap_path):
        ...
        assert result.exit_code == 0
        assert elapsed_time < 5.0, f"XML output took {elapsed_time:.3f} seconds, expected < 5.0 seconds"
    ...
    def test_multiple_product_filters_performance(self, large_sitemap_path):
        ...
        assert result.exit_code == 0
        assert elapsed_time < 3.0, f"Multi-product filtering took {elapsed_time:.3f} seconds, expected < 3.0 seconds"
